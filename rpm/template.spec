...
%global pkg_name tf2_web_republisher_interfaces
%global normalized_pkg_name %{lua:return (string.gsub(rpm.expand('%{pkg_name}'), '_', '-'))}

Name:           ros-lyrical-tf2-web-republisher-interfaces
Version:        1.0.0
Release:        3%{?dist}
...
%description
Interface definitions for tf2_web_republisher
...
%changelog
* Wed Apr 29 2026 Błażej Sowa <blazej@fictionlab.pl> - 1.0.0-3
- Autogenerated by Bloom

* Tue Apr 28 2026 Błażej Sowa <blazej@fictionlab.pl> - 1.0.0-2
- Autogenerated by Bloom

* Tue Apr 21 2026 Błażej Sowa <blazej@fictionlab.pl> - 1.0.0-1
- Autogenerated by Bloom
